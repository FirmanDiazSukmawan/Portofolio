...
function Header() {
  ...
  const text =
    "a human with some ability to love learning and working on teamwork.";
  ...
  return (
    <header
      className="w-[100%] lg:pr-[250px] md:pr-[200px] pr-[0px]"
      id="aboutMe"
    >
      ...
      <div className="flex lg:flex-row md:flex-col flex-col items-center lg:space-y-0 md:space-y-5 space-y-3 lg:pt-0 md:pt-3">
        <div className="flex flex-col lg:items-start md:items-center items-center gap-2">
          <div
            className="lg:w-[124px] lg:h-[124px] sm:w-[120px] sm:h-[120px]
        ...
        <div className="flex flex-col lg:w-[600px] lg:ml-[36px] md:ml-[20px] ml-[5px] lg:space-y-0 md:space-y-0 space-y-2">
          ...
          <div className="font-inter text-[#D6D6D6] lg:text-[18px] lg:text-start md:text-start text-center">
            Firman is a high school graduate with some computer skills and a
            passion for the world of programming, with a focus on Fullstack Web
            & Mobile Development. I am a responsible individual when it comes to
            completing tasks. Exicited on{" "}
            <span className="text-[#87cefa]">React</span>,{" "}
            <span className="text-[#d92186]">Next JS</span>,{" "}
            <span className="text-[#c978eb]">React Native</span>,{" "}
            <span className="text-[#80FFA3]">Node JS</span> and{" "}
            <span className="text-[#3BF686]">Agile</span>.
          </div>
        </div>
        <div className="flex flex-col lg:ml-[86px] lg:h-[168px] items-center">
          ...
          <div className="flex flex-row space-x-4">
            <Popover showArrow placement="bottom">
              <PopoverTrigger>
                <img
                  src={twitter}
                  alt="twitter"
                  className="w-[30px] h-[30px] object-cover transition-transform duration-300 hover:scale-110 cursor-pointer"
                />
              </PopoverTrigger>
              <PopoverContent className="p-1">
                <a href="https://x.com/Tatsuya670676" className="underline">
            ...
            <Popover showArrow placement="bottom">
              ...
              <PopoverContent className="p-1">
                <a
                  href="https://www.instagram.com/firman670676/"
                  className="underline"
                >
                  @firman670676
                </a>
            ...
            <Popover showArrow placement="bottom">
              ...
              <PopoverContent className="p-1">
                <a
                  href="https://www.facebook.com/03MY.Ella.4674/"
                  className="underline"
                >
                  FirmanDiazSukmawan
                </a>
            ...
            <Popover showArrow placement="bottom">
              ...
              <PopoverContent className="p-1">
                <a href="mailto:firman670676@gmail.com" className="underline">
                  firman670676@gmail.com{" "}
                </a>
              </PopoverContent>
            </Popover>
            <Popover showArrow placement="bottom">
              ...
              <PopoverContent className="p-1 flex flex-col items-start justify-start">
                <a
                  href="https://drive.google.com/drive/folders/1gLN4mi_C7s0GwU-Lh4z2QO3YujTM5qkz?usp=sharing"
                  className="underline"
                >
                  My CV{" "}
                </a>
            ...
            <Popover showArrow placement="bottom">
              ...
              <PopoverContent className="p-1 flex flex-col items-start justify-start">
                <a
                  href="https://www.linkedin.com/in/firman-diaz/"
                  className="underline"
                >
                  Firman D.S
                </a>
